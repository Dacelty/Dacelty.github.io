package th.com.example.springTHMVC.localization;

import org.springframework.context.MessageSource;
import org.springframework.context.MessageSourceResolvable;
import org.springframework.context.NoSuchMessageException;
import th.com.example.springTHMVC.model2.LocalizeString;
...
public class DBMessageSource implements MessageSource {
    ...
    public DBMessageSource() {
        ...
        localizeDB.put("category",new LocalizeString("Job","Công việc"));
